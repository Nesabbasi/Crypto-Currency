...
def send_from_P2PKH_transaction(amount_to_send, txid_to_spend, utxo_index):
    ...
    txin_scriptPubKey =  [OP_2DUP, OP_SUB, OP_HASH160, Hash160(DIFF_BYTES), OP_EQUALVERIFY, OP_ADD, OP_HASH160, Hash160(SUM_BYTES), OP_EQUAL]
...
if __name__ == '__main__':
    amount_to_send = 0.007
    txid_to_spend = ('ad83183e28ad752dd7dbb24c2ee779d4e32434b6a62ea9d690286dbdc460001e')
    utxo_index = 0
